...
import (
	...
	"github.com/newspack/selenium/chrome"
	"github.com/newspack/selenium/firefox"
	"github.com/newspack/selenium/log"
	"github.com/newspack/selenium/sauce"
)
...
func TestDocker(t *testing.T) {
	...
	// passed to go test.
	cmd := exec.Command("docker", "run", fmt.Sprintf("--volume=%s:/code", pathToMount), "--workdir=/code/src/github.com/djykissyou/selenium", "go-selenium", "testing/docker-test.sh")
	if testing.Verbose() {
